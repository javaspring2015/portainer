...
.controller('ServiceLogsController', ['$scope', '$transition$', '$interval', 'ServiceService', 'Notifications', 'Authentication',
function ($scope, $transition$, $interval, ServiceService, Notifications, Authentication) {
  $scope.state = {
    refreshRate: 3,
    lineCount: 2000
  };
